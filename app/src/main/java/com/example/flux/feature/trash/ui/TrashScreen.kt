...
fun TrashScreen(
    ...
    val tabs = listOf(
        "\u65e5\u8bb0 ${deletedDiaries.size}",
        "\u5f85\u529e ${deletedTodos.size}",
        "\u4e8b\u4ef6 ${deletedEvents.size}"
    )
    ...
    Scaffold(
        ...
        Column(
            ...
            TrashSummaryCard(
                diaryCount = deletedDiaries.size,
                todoCount = deletedTodos.size,
                eventCount = deletedEvents.size
            )
            ...
            when (selectedTabIndex) {
                0 -> TrashList(
                    ...
                    isEmpty = deletedDiaries.isEmpty(),
                    emptyText = "\u6ca1\u6709\u5df2\u5220\u9664\u7684\u65e5\u8bb0",
                    items = deletedDiaries,
                    key = { it.id }
                ) { diary ->
                    TrashEntryRow(
